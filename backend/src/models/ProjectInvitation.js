...
// 案件募集送信モデルクラス
let ProjectInvitation = class ProjectInvitation extends sequelize_typescript_1.Model {
};
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Number)
], ProjectInvitation.prototype, "partnerId", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
...
], ProjectInvitation.prototype, "invitationDate", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
...
], ProjectInvitation.prototype, "message", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
...
], ProjectInvitation.prototype, "responseDate", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.TEXT,
        allowNull: true
    ...
    __metadata("design:type", String)
], ProjectInvitation.prototype, "responseMessage", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.DATE,
        allowNull: true
    ...
    __metadata("design:type", Object)
], ProjectInvitation.prototype, "responseDeadline", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.TEXT,
        allowNull: true
    ...
    __metadata("design:type", String)
], ProjectInvitation.prototype, "remarks", void 0);
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.DATE,
        allowNull: false,
...
], ProjectInvitation.prototype, "partner", void 0);
ProjectInvitation = __decorate([
